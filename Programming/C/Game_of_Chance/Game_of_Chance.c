...
int get_player_data(){
	int fd, uid, read_bytes, choice;
	struct user entry;

	printf("Register or Use ID to join: \n");
	printf("Enter 1 for Login\n");
	printf("Enter 2 for New Registration\n");
...
void register_new_player(){
	...
	input_name();
	int uid;
	printf("Enter the ID number you like: ");
	scanf("%d", &uid);
	player.uid = uid;
